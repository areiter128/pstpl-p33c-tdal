/*
 * @file    p33c-geminis-03.h
 * @author  Andreas Reiter - M91406
 * @brief   36-pin Sagitta pin mapping header file
 * @version 1.0.7
 * @date    11/06/23
 */
...
// more than once.
#ifndef P33C_GEMINIS_36PIN_H
#define P33C_GEMINIS_36PIN_H
