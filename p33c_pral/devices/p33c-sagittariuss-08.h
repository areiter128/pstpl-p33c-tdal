...
// more than once.
#ifndef P33C_SAGITTARIUSS_80PIN_H
#define P33C_SAGITTARIUSS_80PIN_H
...
#if defined (__P33SMPS_SAGITTARIUSS__)
...
static const P33C_GPIO_t PIN_RA3 = {
    ...
    .Properties.I2C          = -1,                      ///< (not available)
    .Properties.OPA          = -1,                      ///< (not available)
    .Properties.PGA          = 1,                       ///< Index of Programmable Gain Amplifier peripheral instance available at this device pin, =-1 if not available
    .Properties.PG           = -1,                      ///< (not available)
    .Properties.SPI          = -1,                      ///< (not available)
    #ifdef DAC1CONL
    ...
    #endif
    #ifdef PGA1CON
    .Objects.PGA             = (P33C_PGA_INSTANCE_t*)&PGA1CON, ///< Pointer to Programmable Gain Amplifier instance data object available at this device pin
    #else
    .Objects.PGA             = NULL,                    ///< (not available)
    #endif
    #if (P33C_PG_COUNT > 0)
    .Objects.PG              = NULL,                    ///< Pointer to PWM Generator peripheral instance data object available at this device pin
    #endif
...
static const P33C_GPIO_t PIN_RA4 = {
    ...
    .Properties.I2C          = -1,                      ///< (not available)
    .Properties.OPA          = -1,                      ///< (not available)
    .Properties.PGA          = 3,                       ///< Index of Programmable Gain Amplifier peripheral instance available at this device pin, =-1 if not available
    .Properties.PG           = -1,                      ///< (not available)
    .Properties.SPI          = -1,                      ///< (not available)
    #ifdef DAC2CONL
    ...
    #endif
    #ifdef PGA3CON
    .Objects.PGA             = (P33C_PGA_INSTANCE_t*)&PGA3CON, ///< Pointer to Programmable Gain Amplifier instance data object available at this device pin
    #else
    .Objects.PGA             = NULL,                    ///< (not available)
    #endif
    #if (P33C_PG_COUNT > 0)
...
static const P33C_GPIO_t PIN_RC8 = {
    ...
    .Properties.PGA          = -1,                      ///< (not available)
    .Properties.PG           = -1,                      ///< (not available)
    .Properties.SPI          = 1,                       ///< Index of SPI peripheral instance available at this device pin, =-1 if not available
    #if (P33C_DAC_COUNT > 0)
    .Objects.DAC             = NULL,                    ///< Pointer to DAC/Comparator instance data object available at this device pin
    #endif
    #ifdef I2C1CONL
    ...
    #endif
    #ifdef SPI1CON1L
    .Objects.SPI             = (P33C_SPI_INSTANCE_t*)&SPI1CON1L, ///< Pointer to SPI interface peripheral instance data object available at this device pin
    #else
...
static const P33C_GPIO_t PIN_RD12 = {
    ...
    .Properties.I2C          = -1,                      ///< (not available)
    .Properties.OPA          = -1,                      ///< (not available)
    .Properties.PGA          = 2,                       ///< Index of Programmable Gain Amplifier peripheral instance available at this device pin, =-1 if not available
    .Properties.PG           = -1,                      ///< (not available)
    .Properties.SPI          = -1,                      ///< (not available)
    #if (P33C_DAC_COUNT > 0)
    .Objects.DAC             = NULL,                    ///< Pointer to DAC/Comparator instance data object available at this device pin
    ...
    #endif
    #ifdef PGA2CON
    .Objects.PGA             = (P33C_PGA_INSTANCE_t*)&PGA2CON, ///< Pointer to Programmable Gain Amplifier instance data object available at this device pin
    #else
    .Objects.PGA             = NULL,                    ///< (not available)
    #endif
    #if (P33C_PG_COUNT > 0)
...
#endif  /* __P33SMPS_SAGITTARIUSS__  */
#endif  /* P33C_SAGITTARIUSS_80PIN_H */
