...
// more than once.
#ifndef P33C_OCTANSP_80PIN_H
#define P33C_OCTANSP_80PIN_H
...
#if (__P33SMPS_PINCOUNT__ == 80U) || (__P33SMPS_PINCOUNT__ == 100U)
...
static const P33C_GPIO_t PIN_RD6 = {
    ...
    .Properties.PGA          = -1,                      ///< (not available)
    .Properties.PG           = -1,                      ///< (not available)
    .Properties.SPI          = 2,                       ///< (not available)
    #if (P33C_DAC_COUNT > 0)
    .Objects.DAC             = NULL,                    ///< Pointer to DAC/Comparator instance data object available at this device pin
    #endif
    #if (P33C_I2C_COUNT > 0)
...
// Function declarations of port pin RV0
#if (P33C_VP_COUNT >= 1)
static const P33C_GPIO_t PIN_RV0 = {
    .Properties.Port         = 2,                       ///< Index of device port this device pin is part of (0=A, 1=B, 2=C, 3=D, etc), =-1 if not available
    .Properties.Pin          = 4,                       ///< Index of device pin within its device port (0-15), =-1 if not available
    ...
    .Objects.SPI             = NULL,                    ///< Pointer to SPI interface peripheral instance data object available at this device pin
    #endif
    .Methods.Get            = &__builtin_RVX_Get,       ///< Gets the most recent pin state (either logic HIGH = 1 or LOW = 0)
    .Methods.Set            = &__builtin_RVX_Set,       ///< Sets the most recent pin state to logic HIGH
    .Methods.Clear          = &__builtin_RVX_Clear,     ///< Sets the most recent pin state to logic LOW
    .Methods.Toggle         = &__builtin_RVX_Toggle,    ///< Toggles the most recent pin state
    .Methods.SetInput       = &__builtin_RVX_SetInput,  ///< Sets the pin direction to high impedance input (no state change)
    .Methods.SetOutput      = &__builtin_RVX_SetOutput, ///< Sets the pin direction to low impedance output (no state change)
    .Methods.SetState       = &__builtin_RVX_SetState,  ///< Sets the pin direction to low impedance output (no state change)
    .Methods.Init           = &__builtin_RVX_Init,      ///< Initializes the pin setting direction (TRIS = d) and initial state (LAT = s)
    .Methods.Dispose        = &__builtin_RVX_Dispose,   ///< Sets the pin to high impedance input (RESET default)
    .Methods.GetOpenDrain   = &__builtin_RVX_GetOpenDrain, ///< Gets the pin open drain mode
    .Methods.SetOpenDrain   = &__builtin_RVX_SetOpenDrain, ///< Sets the pin open drain mode
    .Methods.GetPullUp      = &__builtin_RVX_GetPullUp, ///< Gets the connection state of the pin's pull up resistor
    .Methods.SetPullUp      = &__builtin_RVX_SetPullUp, ///< Sets the connection state of the pin's pull up resistor
    .Methods.GetPullDown    = &__builtin_RVX_GetPullDown, ///< Gets the connection state of the pin's pull down resistor
    .Methods.SetPullDown    = &__builtin_RVX_SetPullDown, ///< Sets the connection state of the pin's pull down resistor
    .Methods.SetAnalog      = &__builtin_RVX_SetAnalog, ///< Enable analog functions of this pin
    .Methods.SetDigital     = &__builtin_RVX_SetDigital ///< Disable analog functions of this pin
};
#endif // declarations of pin RV0

// Function declarations of port pin RV1
#if (P33C_VP_COUNT >= 2)
static const P33C_GPIO_t PIN_RV1 = {
    .Properties.Port         = 2,                       ///< Index of device port this device pin is part of (0=A, 1=B, 2=C, 3=D, etc), =-1 if not available
    .Properties.Pin          = 5,                       ///< Index of device pin within its device port (0-15), =-1 if not available
...
#endif // declarations of pin RV1

// Function declarations of port pin RV2
#if (P33C_VP_COUNT >= 3)
static const P33C_GPIO_t PIN_RV2 = {
    .Properties.Port         = 2,                       ///< Index of device port this device pin is part of (0=A, 1=B, 2=C, 3=D, etc), =-1 if not available
    .Properties.Pin          = 10,                      ///< Index of device pin within its device port (0-15), =-1 if not available
...
#endif // declarations of pin RV2
#endif // end of P33C_VP_COUNT

#endif  /* __P33SMPS_PINCOUNT__ */
#endif  /* __P33SMPS_OCTANSP__  */
#endif  /* P33C_OCTANSP_80PIN_H */
