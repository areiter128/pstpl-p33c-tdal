/**
 * @file    p33c_pwm.h
 * @see     p33c_pwm-d.h, p33c_pwm-f.h
 * @author  M91406
 */

// This is a guard condition so that contents of this file are not included
// more than once.
#ifndef P33C_PWM_SFR_INTERFACE_H
#define	P33C_PWM_SFR_INTERFACE_H

// Include header files
#include "p33c_pwm-d.h" // Include peripheral abstraction driver header file
#include "p33c_adcan-d.h" // Include ADC register declarations to derive trigger sources
...
/*********************************************************************************
 * @ingroup p33c-pral-pwm-module-templates
 ...
 *
 ********************************************************************************/
static const __attribute__((space(auto_psv))) P33C_PWM_MODULE_t pwmConfigClear =
{
    .PCLKCON.value = 0x0000, // HRRDY=0, HRERR=0, LOCK=0, DIVSEL=0b00, MCLKSEL=0b00
    .FSCL.value = 0x0000, // FSCL=0
    .FSMINPER.value = 0x0000, // FSMINPER=0
    .MPHASE.value = 0x0000, // MPHASE=0
    .MDC.value = 0x0000, // MDC=0
    .MPER.value = 0x0000, // MPER=0
    .LFSR.value = 0x0000, // LFSR=0
    .CMBTRIGL.value = 0x0000, // CTA1EN=0, CTA2EN=0, CTA3EN=0, CTA4EN=0, CTA5EN=0, CTA6EN=0, CTA7EN=0, CTA8EN=0
    .CMBTRIGH.value = 0x0000, // CTB1EN=0, CTB2EN=0, CTB3EN=0, CTB4EN=0, CTB5EN=0, CTB6EN=0, CTB7EN=0, CTB8EN=0
 ...
 *
 ********************************************************************************/
static const __attribute__((space(auto_psv))) P33C_PWM_MODULE_t pwmConfigDefault =
{
    .PCLKCON.value = 0x0003,   // HRRDY=0, HRERR=0, LOCK=0, DIVSEL=0b00, MCLKSEL=0b11
    .FSCL.value = 0x0000,      // FSCL=0
    .FSMINPER.value = 0x0000,  // FSMINPER=0
    .MPHASE.value = 0x0000,    // MPHASE=0
    .MDC.value = 0x0000,       // MDC=0
...
/*********************************************************************************
 * @ingroup p33c-pral-pwm-instance-templates
 ...
 *
 ********************************************************************************/
static const __attribute__((space(auto_psv))) P33C_PWM_INSTANCE_t pgConfigClear =
{
 ...
 * @brief   Enables power to PWM peripheral
 * @return  0 = failure, writing to PWM registers was not successful
 * @return  1 = success, writing to PWM registers was successful
 * @details
 ...
 *  on the power supply to the PWM peripheral.
 *
 * @note
 ...
 *
 **********************************************************************************/
static inline int p33c_PwmModule_PowerOn(void)
{
    int retval = 1;
    ...
    #endif
    #ifdef PMD1
    PMD1bits.PWMMD = 0; // Enable power to PWM peripheral
    retval = 1 - _PWMMD;
    #endif
    #ifdef APCLKCON
    PMD4bits.APWM = 0; // Enable power to APWM peripheral
    retval = 1 - _APWM;
    #endif
    #ifdef PMDCON
...
/*********************************************************************************
 * @ingroup p33c-pral-pwm-module-methods
 * @brief   Disables power to PWM peripheral
 * @return  0 = failure, writing to PWM registers was not successful
 * @return  1 = success, writing to PWM registers was successful
 * @details
 *  Peripheral Module Disable Module (PMD) registers allow to cut power to
 *  unused peripherals to reduce power consumption. This routine turns
 *  off the power supply to the PWM peripheral.
 *
 * @note
 ...
 *
 **********************************************************************************/
static inline int p33c_PwmModule_PowerOff(void)
{
    int retval = 1;
    ...
    #endif
    #ifdef PMD1
    PMD1bits.PWMMD = 1; // Disable power to PWM peripheral
    retval = _PWMMD;
    #endif
    #ifdef APCLKCON
    PMD4bits.APWM = 1; // Disable power to APWM peripheral
    retval = _APWM;
    #endif
    #ifdef PMDCON
    PMDCONbits.PMDLOCK = 1; // Lock PMD registers
 ...
 *
 *********************************************************************************/
#define p33c_PwmModule_Initialize() p33c_PwmModule_SetConfig(pwmConfigDefault)
 ...
 *
 *********************************************************************************/
#define p33c_PwmModule_Dispose()    p33c_PwmModule_SetConfig(pwmConfigClear)

/*********************************************************************************
 * @ingroup p33c-pral-pwm-module-methods
 * @brief   Read the current configuration from the PWM base module registers
 * @return  P33C_PWM_MODULE_t
 *
 * @details
 ...
 *
 *********************************************************************************/
#define p33c_PwmModule_GetConfig() (P33C_PWM_MODULE_t)p33c_PwmModule_GetHandle()

/*********************************************************************************
 * @ingroup p33c-pral-pwm-module-methods
 * @brief   Writes a user-defined configuration to the PWM base module registers
 * @param   pwmConfig PWM module register set of type P33C_PWM_MODULE_t
 * @return  0 = failure, disposing PWM generator was not successful
 * @return  1 = success, disposing PWM generator was successful
 *
 * @details
 ...
 *
 *********************************************************************************/
static inline int p33c_PwmModule_SetConfig(P33C_PWM_MODULE_t pwmConfig)
{
    int retval = 1;

    // Set pointer to memory address of the PWM module
    volatile P33C_PWM_MODULE_t* pwm = p33c_PwmModule_GetHandle();
    *pwm = pwmConfig;

    #ifdef APCLKCON
    // Set pointer to memory address of the APWM module
    pwm = p33c_ApwmModule_GetHandle();
    *pwm = pwmConfig;
    #endif
...
//    int retval = 1;
//
//    retval = p33c_PwmModule_SetConfig(pwmConfigClear);
//
//    return(retval);
//}
 ...
 * @return  Generic PWM generator Special Function Register set of type P33C_PWM_INSTANCE_t
 *
 * @details
 ...
 *     P33C_PWM_INSTANCE_t. This 'virtual' PWM configuration can then , for
 *     example, be analyzed and/or modified in user code and applied to another
 *     PWM generator using the function p33c_PwmInstance_SetConfig(...).
 *
 *********************************************************************************/
static inline P33C_PWM_INSTANCE_t p33c_PwmInstance_GetConfig(uint16_t pgInstance)
{
    if (p33c_PwmInstance_Exists(pgInstance))
    {
        // Set pointer to memory address of desired PWM instance
        volatile P33C_PWM_INSTANCE_t* pg = p33c_PwmInstance_GetHandle(pgInstance);
        return(*pg);
    }
    else { return(pgConfigClear); }
 ...
 * @param   pgConfig   Generic PWM generator Special Function Register set of type P33C_PWM_INSTANCE_t
 * @return  0 = failure, disposing PWM generator was not successful
 * @return  1 = success, disposing PWM generator was successful
 *
 * @details
 *     This function writes a user-defined PWM generator configuration of type
 *     P33C_PWM_INSTANCE_t to the given PWM generator peripheral instance (e.g. PG2).
 *
 *********************************************************************************/
static inline int p33c_PwmInstance_SetConfig(uint16_t pgInstance, P33C_PWM_INSTANCE_t pgConfig)
{
    int retval = 1;
 ...
 *
 *********************************************************************************/
static inline int p33c_PwmInstance_Enable(uint16_t pgInstance)
{
    int retval = 1;
    uint16_t timeout=0;
    ...
    if (p33c_PwmInstance_Exists(pgInstance))
    {
        // Capture pointer to memory address of desired PWM instance
        volatile P33C_PWM_INSTANCE_t* pg = p33c_PwmInstance_GetHandle(pgInstance);
        ...
        {
            // Poll on High Resolution Ready bit with timeout counter
 ...
 *
 *********************************************************************************/
static inline int p33c_PwmInstance_Disable(uint16_t pgInstance)
{
    int retval = 1;
 ...
 *
 *********************************************************************************/
static inline int p33c_PwmInstance_Initialize(uint16_t pgInstance)
{
    int retval = 1;
    ...
    if (p33c_PwmInstance_Exists(pgInstance))
    {
        ...
        retval &= p33c_PwmInstance_Disable(pgInstance);

        // Reset all SFRs to default
        retval &= p33c_PwmInstance_SetConfig(pgInstance, pgConfigClear);
 ...
 *
 * ********************************************************************************/
static inline int p33c_PwmInstance_Dispose(uint16_t pgInstance)
{
    int retval = 1;
    ...
    if (p33c_PwmInstance_Exists(pgInstance))
    {
        ...
        p33c_PwmInstance_SetConfig(pgInstance, pgConfigClear);
    }
    else { retval = 0; }
 ...
 *
 *********************************************************************************/
static inline int p33c_PwmInstance_Resume(uint16_t pgInstance)
{
    int retval = 1;
 ...
 *
 *********************************************************************************/
static inline int p33c_PwmInstance_Suspend(uint16_t pgInstance)
{
    int retval = 1;
 ...
 *
 *********************************************************************************/
static inline int p33c_PwmInstance_SetPeriod(uint16_t pgInstance, uint16_t period)
{
    int retval = 1;
 ...
 *
 *********************************************************************************/
static inline int p33c_PwmInstance_SetDutyCycle(uint16_t pgInstance, uint16_t duty)
{
    int retval = 1;
 ...
 * @param   pgInstance Instance of the PWM generator of type unsigned integer (e.g. 1=PG1, 2=PG2, etc.)
 * @param   deadTimeRising  Rising edge dead time counter value of type unsigned integer
 / @param   deadTimeFalling Falling edge dead time counter value of type unsigned integer
 * @return  0 = failure, disabling PWM generator was not successful
 * @return  1 = success, disabling PWM generator was successful
 *
 * @details
 ...
 *
 *********************************************************************************/
static inline int p33c_PwmInstance_SetDeadTimes(uint16_t pgInstance, uint16_t deadTimeRising, uint16_t deadTimeFalling)
{
    int retval = 1;
    ...
    if (p33c_PwmInstance_Exists(pgInstance))
    {
        ...
        // Set PWM generator period
        pg->PGxDTH.value = deadTimeRising;
        pg->PGxDTL.value = deadTimeFalling;
    }
    else { retval = 0; }
 ...
 * @param   pg  Pointer to PWM generator peripheral instance register set of type P33C_PWM_GENERATOR_t
 ...
 *
 *********************************************************************************/
static inline int p33c_PwmInstance_GetInstance(P33C_PWM_INSTANCE_t* pg)
{
    int retval = 1;

	if(pg == NULL) return(0); // NULL pointer protection

    uint16_t pgSfrAddr = (uint16_t)&PG1CONL;
    uint16_t pgSfrOffset = 1;

    #ifdef APCLKCON
    if ((uint16_t)&pg->PGxCONL < (uint16_t)&PG1CONL)
    {
        pgSfrAddr = (uint16_t)&APG1CONL;
        pgSfrOffset = 9;
    }
    #endif

    // Capture Instance: set pointer to memory address of desired PWM instance
    retval = (uint16_t)(((uint16_t)&pg->PGxCONL - pgSfrAddr) / P33C_PWMGEN_SFR_OFFSET) + pgSfrOffset;

    if (retval > p33c_PwmInstances)
 ...
 * @return  3 = PWM generator is in group #3
 *
 * @details
 * This function identify the group to which the PWM generator instance belongs
 * (1 = [PG1-PG4], 2 = [PG5-PG8], 3 = [APG1-APG4]) and verifies if the PWMgenerator
 * group is valid and available. If no group is found, the function returns '0'
 *********************************************************************************/
static inline int p33c_PwmInstance_GetGroup(P33C_PWM_INSTANCE_t* pg)
{
    int retval = 1;
    ...
    uint16_t pgInstance = p33c_PwmInstance_GetInstance(pg);

    // Verify PWM generator group is valid and available
    if (pgInstance > p33c_PwmInstances)
        return(0); // PWM generator not member of a valid group
    else if (pgInstance > 8)
        retval = 3; // PWM generator is member of group #3 [APG1-APG4]
 ...
 * @param   pgHandleMother Pointer to PWM generator object of type P33C_PWM_GENERATOR_t of triggering PWM generator (sync trigger provider)
 ...
 *              2 = PGxTRIGB
 *              3 = PGxTRIGC
 * @param   pgHandleChild  Pointer to PWM generator object of type P33C_PWM_GENERATOR_t of triggered PWM generator (sync trigger receiver)
 ...
 *
 *********************************************************************************/
static inline int p33c_PwmInstance_SyncGenerators(P33C_PWM_INSTANCE_t* pgHandleMother,
                    uint16_t pgMotherTriggerOutput,
                    P33C_PWM_INSTANCE_t* pgHandleChild, bool ChildImmediateUpdate
    )
{
    int retval = 1;
    uint16_t pgInstance;
    ...
    uint16_t pgMotherInstance = p33c_PwmInstance_GetInstance(pgHandleMother);
    uint16_t pgMotherGroup = p33c_PwmInstance_GetGroup(pgHandleMother);
    uint16_t pgChildGroup = p33c_PwmInstance_GetGroup(pgHandleChild);
    ...
    */
    ...
    if (pgMotherGroup == pgChildGroup)
    {
        ...
        if ((1 == pgMotherGroup) || (3 == pgMotherGroup))
            pgHandleChild->PGxCONH.bits.SOCS = pgMotherInstance;
        else if (2 == pgMotherGroup)
    ...
    {
        // Exit if PWM generator group corresponds to APWM
        if (3 == pgMotherGroup)
        { return (0); } // APWM generator cannot be in sync with PWM generators

        // Synchronization across PWM generator groups need to be routed
        // through the PCI Sync function

        pgInstance = p33c_PwmInstance_GetInstance(pgHandleChild);
...
/*********************************************************************************
 * @ingroup p33c-pral-pwm-instance-methods
 * @brief   Gets the ADC trigger source ID of the requesting PWM generator
 * @param   pgInstance Index of the PWM generator peripheral instance
 * @param   triggerIndex Can be =0 (primary trigger) or =1 (secondary trigger)
 * @return  ADC trigger source ID of requesting PWM generator
 *
 * @details
 *      This function returns the ADC trigger soruce ID of the requesting PWM generator.
...
static inline uint8_t p33c_PwmInstance_GetTriggerSource(uint16_t pgInstance, uint16_t triggerIndex)
{
    uint8_t trgsrc = 0;
    
    // Guarding conditions
    if (triggerIndex > 1) { return(trgsrc); }
    
    switch (pgInstance)
    {
        #if defined (PG1CONL)
        case 1U: trgsrc = ADCAN_TRGSRC_PWM1_TRG1 | triggerIndex; break;
        #endif
        #if defined (PG2CONL)
        case 2U: trgsrc = ADCAN_TRGSRC_PWM2_TRG1 | triggerIndex; break;
        #endif
        #if defined (PG3CONL)
        case 3U: trgsrc = ADCAN_TRGSRC_PWM3_TRG1 | triggerIndex; break;
        #endif
        #if defined (PG4CONL)
        case 4U: trgsrc = ADCAN_TRGSRC_PWM4_TRG1 | triggerIndex; break;
        #endif
        #if defined (PG5CONL)
        case 5U: trgsrc = ADCAN_TRGSRC_PWM5_TRG1 | triggerIndex; break;
        #endif
        #if defined (PG6CONL)
        case 6U: trgsrc = ADCAN_TRGSRC_PWM6_TRG1 | triggerIndex; break;
        #endif
        #if defined (PG7CONL)
        case 7U: trgsrc = ADCAN_TRGSRC_PWM7_TRG1 | triggerIndex; break;
        #endif
        #if defined (PG8CONL)
        case 8U: trgsrc = ADCAN_TRGSRC_PWM8_TRG1 | triggerIndex; break;
        #endif
        #if defined (APCLKCON)
            #if defined(APG4CONL)
            case 9U: trgsrc = ADCAN_TRGSRC_APWM1_TRG1 | triggerIndex; break;
            #endif
            #if defined(APG4CONL)
            case 10U: trgsrc = ADCAN_TRGSRC_APWM2_TRG1 | triggerIndex; break;
            #endif
            #if defined(APG4CONL)
            case 11U: trgsrc = ADCAN_TRGSRC_APWM3_TRG1 | triggerIndex; break;
            #endif
            #if defined(APG4CONL)
            case 12U: trgsrc = ADCAN_TRGSRC_APWM4_TRG1 | triggerIndex; break;
            #endif
        #endif
...
#endif /* End of P33C_PWM_SFR_INTERFACE_H */
